...
Here I made an interactive plot \@ref(fig:crosstalk) to play with; we may select the date and countries shown in the figure to see the confirmed cases with the time change. 
...
The Figure \@ref(fig:cc-pop) shows that the number of confirmed cases per thousand people of Singapore kept low after 8 August 2020. Even experienced several pandemic waves, the increases were much slower than all the other South-eastern Asian countries.
